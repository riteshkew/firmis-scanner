...
description: Integrate Firmis into GitHub Actions CI/CD pipelines with SARIF upload, PR comments, and branch protection.
---

import { Aside, Card, CardGrid, Steps, Tabs, TabItem } from '@astrojs/starlight/components'

> Add Firmis to your GitHub Actions pipeline in under 5 minutes. Get findings in the Security tab, PR annotations, and enforce security gates on every push.
...
When you upload a SARIF file with `github/codeql-action/upload-sarif@v3`, GitHub displays findings as:
...
- [TypeScript API](/integrations/typescript-api)
