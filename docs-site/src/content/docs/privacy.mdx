---
title: "Privacy"
description: "Privacy policy for Firmis Scanner. Offline-first, no data collected by default."
---

> Firmis Scanner is offline-first. By default, nothing leaves your machine.
