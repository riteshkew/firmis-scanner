...
description: "Generate compliance reports mapped to SOC 2, EU AI Act, GDPR, and NIST frameworks from Firmis scan findings (Beta)."
---

import { Aside } from '@astrojs/starlight/components';

> Firmis maps every scan finding to compliance framework controls — so a security scan is also an audit artifact. One scan, five frameworks.
...
- [Agent Supply Chain Security →](/guides/agent-supply-chain-security)
- [Firmis Engine private beta →](https://firmislabs.com)
