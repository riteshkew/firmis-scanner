---
title: Custom Rules
description: Write and load your own YAML detection rules to extend Firmis with project-specific threat patterns.
---

import { Aside } from '@astrojs/starlight/components';

> Custom rules use the same YAML schema as built-in rules. Write one, point Firmis at it, and your pattern runs alongside the 209 built-in rules on every scan.
...
- [Built-in Rules](/rules/built-in-rules) — browse the 209 built-in rules for inspiration
