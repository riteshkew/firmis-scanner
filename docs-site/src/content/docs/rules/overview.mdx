...
description: How Firmis detection rules work — YAML anatomy, pattern matcher types, severity levels, and rule loading.
---

import { Aside } from '@astrojs/starlight/components';

> Firmis rules are YAML files that define what to look for and how confident to be before reporting a finding. Built-in rules ship with the npm package. Custom rules load from your project or config file.
...
- [Custom Rules](/rules/custom-rules) — full YAML schema and working examples
