...
description: Suppress false positives and silence known-safe patterns using .firmisignore or the --ignore flag.
---
...
- [Custom Rules](/rules/custom-rules) — writing YAML rules to extend detection
