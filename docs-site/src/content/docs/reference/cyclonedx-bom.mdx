...
description: CycloneDX 1.7 Agent BOM output format — field mappings, JSON structure, generation commands, Dependency-Track integration, and a complete example.
---

import { Aside } from '@astrojs/starlight/components';

> Firmis generates Agent Bills of Materials in CycloneDX 1.7 format — the same standard used for software supply chain compliance. This page is the output format field reference. For the concept and motivation, see [Agent BOM](/concepts/agent-bom).
...
<Aside type="tip">
  Archiving BOMs as CI artifacts gives you a dated record of your agent's composition at every deployment. This directly supports SOC 2 Type II audit evidence and AI Act Article 13 transparency requirements.
</Aside>
...
- [SARIF Output](/reference/sarif-output) — scan findings output format
