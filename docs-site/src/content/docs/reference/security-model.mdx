...
description: What Firmis detects and what it does not — confidence scoring, false positive expectations, detection boundaries, and the limits of static analysis for AI agent security.
---

import { Aside } from '@astrojs/starlight/components';

> Firmis is a static analysis scanner. It reads code and configuration files to find threats embedded before deployment. It cannot observe live agent behavior, intercept network traffic, or detect threats that only manifest at runtime. This page documents exactly what Firmis covers and where coverage ends.
...
- [Threat Categories](/reference/threat-categories) — all 16 categories with OWASP/MITRE mappings
