...
description: Complete reference for all Firmis configuration options — CLI flags, config file schema, environment variables, and defaults.
---

import { Aside } from '@astrojs/starlight/components';

> Firmis works with zero configuration — `npx firmis scan .` is enough for most projects. When you need to tune behavior for your project, this page documents every available option.
...
- [Ignoring Findings](/rules/ignoring-findings) — `.firmisignore` syntax
- [Custom Rules](/rules/custom-rules) — writing your own detection rules
